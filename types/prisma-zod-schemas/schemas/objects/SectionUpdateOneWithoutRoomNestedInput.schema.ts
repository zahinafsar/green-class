...
const Schema: z.ZodType<Prisma.SectionUpdateOneWithoutRoomNestedInput> = z
  .object({
    create: z
      .union([
    ...
    connectOrCreate: z
      ...
      .optional(),
    upsert: z.lazy(() => SectionUpsertWithoutRoomInputObjectSchema).optional(),
...
export const SectionUpdateOneWithoutRoomNestedInputObjectSchema = Schema;
