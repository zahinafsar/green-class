...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateNestedManyWithoutRoomInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedCreateNestedManyWithoutRoomInputObjectSchema =
  Schema;
