...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutRoomNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => MessageUpsertWithWhereUniqueWithoutRoomInputObjectSchema,
          ),
          z
            .lazy(
              () => MessageUpsertWithWhereUniqueWithoutRoomInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => MessageUpdateWithWhereUniqueWithoutRoomInputObjectSchema,
          ),
          z
            .lazy(
              () => MessageUpdateWithWhereUniqueWithoutRoomInputObjectSchema,
...
export const MessageUncheckedUpdateManyWithoutRoomNestedInputObjectSchema =
  Schema;
