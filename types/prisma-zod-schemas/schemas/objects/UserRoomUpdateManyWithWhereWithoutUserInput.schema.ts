...
const Schema: z.ZodType<Prisma.UserRoomUpdateManyWithWhereWithoutUserInput> = z
  .object({
...
export const UserRoomUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
