...
const Schema: z.ZodType<Prisma.UserRoomUncheckedUpdateManyWithoutRoomNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => UserRoomUpsertWithWhereUniqueWithoutRoomInputObjectSchema,
          ),
          z
            .lazy(
              () => UserRoomUpsertWithWhereUniqueWithoutRoomInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => UserRoomUpdateWithWhereUniqueWithoutRoomInputObjectSchema,
          ),
          z
            .lazy(
              () => UserRoomUpdateWithWhereUniqueWithoutRoomInputObjectSchema,
...
export const UserRoomUncheckedUpdateManyWithoutRoomNestedInputObjectSchema =
  Schema;
