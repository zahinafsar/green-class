...
const Schema: z.ZodType<Prisma.UserRoomUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserRoomUpsertWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => UserRoomUpsertWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => UserRoomUpdateWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => UserRoomUpdateWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserRoomUpdateManyWithoutUserNestedInputObjectSchema = Schema;
