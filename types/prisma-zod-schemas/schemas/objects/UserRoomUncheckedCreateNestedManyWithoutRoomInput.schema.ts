...
const Schema: z.ZodType<Prisma.UserRoomUncheckedCreateNestedManyWithoutRoomInput> =
  z
    .object({
      create: z
        .union([
...
export const UserRoomUncheckedCreateNestedManyWithoutRoomInputObjectSchema =
  Schema;
