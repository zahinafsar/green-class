...
const Schema: z.ZodType<Prisma.FacultyUncheckedUpdateOneWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => FacultyUpsertWithoutUserInputObjectSchema)
        .optional(),
...
export const FacultyUncheckedUpdateOneWithoutUserNestedInputObjectSchema =
  Schema;
